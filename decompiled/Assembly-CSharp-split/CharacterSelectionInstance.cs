...
public class CharacterSelectionInstance : MonoBehaviour
{
	...
	public void ResetMenu()
	{
		...
		currentPlayer = null;
		getReadyObj.gameObject.SetActive(value: false);
	...
	private void OnEnable()
	{
		...
		{
			GetComponentInChildren<GeneralParticleSystem>(includeInactive: true).gameObject.SetActive(value: true);
			GetComponentInChildren<GeneralParticleSystem>(includeInactive: true).Play();
		}
	}
	...
	public void StartPicking(Player pickingPlayer)
	{
		...
		GetComponentInChildren<GeneralParticleSystem>(includeInactive: true).gameObject.SetActive(value: false);
		GetComponentInChildren<GeneralParticleSystem>(includeInactive: true).Stop();
		base.transform.GetChild(0).gameObject.SetActive(value: true);
		getReadyObj.gameObject.SetActive(value: true);
	...
	private void Update()
	{
		...
		if (currentPlayer.data.input.inputType != GeneralInput.InputType.Controller)
		{
