...
public class ElementCrusher : Crusher<ElementCrusher>, IEquatable<ElementCrusher>, ICrusherCopy<ElementCrusher>
{
	...
	public bool Enabled
	{
		get
		{
			...
			if (TRSType == TRSType.Scale && uniformAxes != UniformAxes.NonUniform)
			{
		...
		set
		{
			...
			else if (TRSType == TRSType.Scale && uniformAxes != UniformAxes.NonUniform)
			{
	...
	public static ElementCrusher GetStaticQuatCrusher(int minBits)
	{
		...
		{
			QCrusher = new QuatCrusher(showEnableToggle: false, isStandalone: false)
			{
				Bits = minBits
			}
		});
	...
	public void Defaults(TRSType trs)
	{
		...
		case TRSType.Quaternion:
			XCrusher = new FloatCrusher(BitPresets.Bits10, -90f, 90f, Axis.X, TRSType.Euler, showEnableToggle: true);
			YCrusher = new FloatCrusher(BitPresets.Bits12, -180f, 180f, Axis.Y, TRSType.Euler, showEnableToggle: true);
			ZCrusher = new FloatCrusher(BitPresets.Bits10, -180f, 180f, Axis.Z, TRSType.Euler, showEnableToggle: true);
			QCrusher = new QuatCrusher(showEnableToggle: true, isStandalone: false);
			break;
		case TRSType.Scale:
			XCrusher = new FloatCrusher(BitPresets.Bits12, 0f, 2f, Axis.X, TRSType.Scale, showEnableToggle: true);
			YCrusher = new FloatCrusher(BitPresets.Bits10, 0f, 2f, Axis.Y, TRSType.Scale, showEnableToggle: true);
			ZCrusher = new FloatCrusher(BitPresets.Bits10, 0f, 2f, Axis.Z, TRSType.Scale, showEnableToggle: true);
			UCrusher = new FloatCrusher(BitPresets.Bits10, 0f, 2f, Axis.Uniform, TRSType.Scale, showEnableToggle: true);
			break;
		default:
			XCrusher = new FloatCrusher(BitPresets.Bits12, -20f, 20f, Axis.X, trs, showEnableToggle: true);
			YCrusher = new FloatCrusher(BitPresets.Bits10, -5f, 5f, Axis.Y, trs, showEnableToggle: true);
			ZCrusher = new FloatCrusher(BitPresets.Bits10, -5f, 5f, Axis.Z, trs, showEnableToggle: true);
			break;
		}
	}
	...
	{
		return TRSType switch
		{
			TRSType.Position => Write(local ? trans.localPosition : trans.position, bytes, ref bitposition, bcl), 
			TRSType.Euler => Write(local ? trans.localEulerAngles : trans.eulerAngles, bytes, ref bitposition, bcl), 
			TRSType.Quaternion => Write(local ? trans.localRotation : trans.rotation, bytes, ref bitposition, bcl), 
			TRSType.Scale => Write(trans.localScale, bytes, ref bitposition, bcl), 
			_ => Write(local ? trans.localPosition : trans.position, bytes, ref bitposition, bcl), 
		};
	}
	...
	public void Write(CompressedElement ce, byte[] buffer, ref int bitposition, IncludedAxes ia = IncludedAxes.XYZ, BitCullingLevel bcl = BitCullingLevel.NoCulling)
	{
		...
		if (cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None)
		{
			_xcrusher.Write(ce.cx, buffer, ref bitposition, bcl);
		}
		if (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None)
		{
			_ycrusher.Write(ce.cy, buffer, ref bitposition, bcl);
		}
		if (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None)
		{
	...
	public void Compress(CompressedElement nonalloc, Rigidbody rb, IncludedAxes ia = IncludedAxes.XYZ)
	{
		...
		case TRSType.Euler:
		{
			...
			CompressedFloat cx2 = ((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? _xcrusher.Compress(vector2.x) : default(CompressedFloat));
			CompressedFloat cy2 = ((cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? _ycrusher.Compress(vector2.y) : default(CompressedFloat));
			CompressedFloat cz2 = ((cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? _zcrusher.Compress(vector2.z) : default(CompressedFloat));
		...
		case TRSType.Position:
		{
			...
			CompressedFloat cx = ((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? _xcrusher.Compress(vector.x) : default(CompressedFloat));
			CompressedFloat cy = ((cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? _ycrusher.Compress(vector.y) : default(CompressedFloat));
			CompressedFloat cz = ((cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? _zcrusher.Compress(vector.z) : default(CompressedFloat));
			nonalloc.Set(this, cx, cy, cz);
			break;
		}
		default:
	...
	public void Compress(CompressedElement nonalloc, Vector3 v, IncludedAxes ia = IncludedAxes.XYZ)
	{
		...
		{
			CompressedFloat cx = ((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? _xcrusher.Compress(v.x) : default(CompressedFloat));
			CompressedFloat cy = ((cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? _ycrusher.Compress(v.y) : default(CompressedFloat));
			CompressedFloat cz = ((cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? _zcrusher.Compress(v.z) : default(CompressedFloat));
			nonalloc.Set(this, cx, cy, cz);
		}
	}
	...
	public Element Decompress(ulong cval, IncludedAxes ia = IncludedAxes.XYZ)
	{
		...
		int bitposition = 0;
		return new Vector3((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? _xcrusher.ReadAndDecompress(cval, ref bitposition) : 0f, (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? _ycrusher.ReadAndDecompress(cval, ref bitposition) : 0f, (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? _zcrusher.ReadAndDecompress(cval, ref bitposition) : 0f);
	}
	...
	public void Apply(Rigidbody rb, Element e, IncludedAxes ia = IncludedAxes.XYZ)
	{
		...
		case TRSType.Position:
		{
			...
			rb.MovePosition(new Vector3((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? vector.x : position.x, (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? vector.y : position.y, (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? vector.z : position.z));
			break;
		}
		case TRSType.Euler:
		{
			...
			if (local && (bool)rb.transform.parent)
			{
				rb.transform.eulerAngles = new Vector3((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? e.v.x : eulerAngles.x, (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? e.v.y : eulerAngles.y, (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? e.v.z : eulerAngles.z);
			}
			else
			{
				rb.MoveRotation(Quaternion.Euler((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? e.v.x : eulerAngles.x, (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? e.v.y : eulerAngles.y, (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? e.v.z : eulerAngles.z));
			}
			break;
		}
		default:
	...
	public void Move(Rigidbody rb, Element e, IncludedAxes ia = IncludedAxes.XYZ)
	{
		...
		{
			Vector3 vector = ((local & (bool)rb.transform.parent) ? rb.transform.TransformPoint(e.v) : e.v);
			rb.MovePosition(new Vector3((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? vector.x : rb.position.x, (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? vector.y : rb.position.y, (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? vector.z : rb.position.z));
			break;
		}
		case TRSType.Euler:
		{
	...
	public void Set(Rigidbody rb, Element e, IncludedAxes ia = IncludedAxes.XYZ)
	{
		...
		case TRSType.Position:
		{
			Vector3 vector = ((local & (bool)rb.transform.parent) ? rb.transform.TransformPoint(e.v) : e.v);
			Vector3 position = rb.position;
			rb.position = new Vector3((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? vector.x : position.x, (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? vector.y : position.y, (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? vector.z : position.z);
			break;
		}
		case TRSType.Euler:
		{
			...
			{
				rb.rotation = Quaternion.Euler((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? e.v.x : eulerAngles.x, (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? e.v.y : eulerAngles.y, (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? e.v.z : eulerAngles.z);
			}
			break;
		}
		default:
	...
	public void Set(Rigidbody2D rb2d, Element e, IncludedAxes ia = IncludedAxes.XYZ)
	{
		...
		case TRSType.Position:
		{
			...
			rb2d.position = new Vector2((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? vector.x : rb2d.position.x, (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? vector.y : rb2d.position.y);
			break;
		}
		case TRSType.Euler:
			if (local && (bool)rb2d.transform.parent)
			{
				rb2d.transform.localEulerAngles = new Vector3(0f, 0f, (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? e.v.z : rb2d.rotation);
			}
			else
			{
				rb2d.rotation = ((cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? e.v.z : rb2d.rotation);
			}
			break;
		default:
			Debug.LogError("Are you trying to Apply scale to a Rigidbody?");
	...
	public void Apply(Transform trans, Element e, IncludedAxes ia = IncludedAxes.XYZ)
	{
		...
		case TRSType.Position:
			if (local)
			{
				trans.localPosition = new Vector3((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? e.v.x : trans.localPosition.x, (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? e.v.y : trans.localPosition.y, (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? e.v.z : trans.localPosition.z);
			}
			else
			{
				trans.position = new Vector3((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? e.v.x : trans.position.x, (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? e.v.y : trans.position.y, (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? e.v.z : trans.position.z);
			}
			return;
		case TRSType.Euler:
			if (local)
			{
				trans.localEulerAngles = new Vector3((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? e.v.x : trans.localEulerAngles.x, (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? e.v.y : trans.localEulerAngles.y, (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? e.v.z : trans.localEulerAngles.z);
			}
			else
			{
				trans.eulerAngles = new Vector3((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? e.v.x : trans.eulerAngles.x, (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? e.v.y : trans.eulerAngles.y, (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? e.v.z : trans.eulerAngles.z);
			}
			return;
		}
		if (local)
		{
			...
			{
				trans.localScale = new Vector3((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? e.v.x : trans.localScale.x, (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? e.v.y : trans.localScale.y, (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? e.v.z : trans.localScale.z);
				return;
			}
			float num = (((uniformAxes & (UniformAxes)1) != UniformAxes.NonUniform) ? e.v.x : e.v.y);
			trans.localScale = new Vector3(((uniformAxes & (UniformAxes)1) != UniformAxes.NonUniform) ? num : trans.localScale.x, ((uniformAxes & (UniformAxes)2) != UniformAxes.NonUniform) ? num : trans.localScale.y, ((uniformAxes & (UniformAxes)4) != UniformAxes.NonUniform) ? num : trans.localScale.z);
		}
		else if (uniformAxes == UniformAxes.NonUniform)
		{
			trans.localScale = new Vector3((cache_xEnabled && (ia & IncludedAxes.X) != IncludedAxes.None) ? e.v.x : trans.lossyScale.x, (cache_yEnabled && (ia & IncludedAxes.Y) != IncludedAxes.None) ? e.v.y : trans.lossyScale.y, (cache_zEnabled && (ia & IncludedAxes.Z) != IncludedAxes.None) ? e.v.z : trans.lossyScale.z);
		}
		else
		{
			float num2 = (((uniformAxes & (UniformAxes)1) != UniformAxes.NonUniform) ? e.v.x : e.v.y);
			trans.localScale = new Vector3(((uniformAxes & (UniformAxes)1) != UniformAxes.NonUniform) ? num2 : trans.lossyScale.x, ((uniformAxes & (UniformAxes)2) != UniformAxes.NonUniform) ? num2 : trans.lossyScale.y, ((uniformAxes & (UniformAxes)4) != UniformAxes.NonUniform) ? num2 : trans.lossyScale.z);
		}
	}
	...
	public Vector3 Clamp(Vector3 v3)
	{
		...
		if (TRSType == TRSType.Scale)
		{
			...
			return new Vector3(((uniformAxes & (UniformAxes)1) != UniformAxes.NonUniform) ? _ucrusher.Clamp(v3.x) : 0f, ((uniformAxes & (UniformAxes)2) != UniformAxes.NonUniform) ? _ucrusher.Clamp(v3.x) : 0f, ((uniformAxes & (UniformAxes)4) != UniformAxes.NonUniform) ? _ucrusher.Clamp(v3.x) : 0f);
		}
