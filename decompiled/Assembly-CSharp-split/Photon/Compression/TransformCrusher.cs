...
public class TransformCrusher : Crusher<TransformCrusher>, ICrusherCopy<TransformCrusher>
{
	...
	protected virtual void ConstructDefault(bool isStatic = false)
	{
		if (!isStatic)
		{
			...
			RotCrusher = new ElementCrusher(TRSType.Euler, enableTRSTypeSelector: false)
			{
				XCrusher = new FloatCrusher(BitPresets.Bits12, -90f, 90f, Axis.X, TRSType.Euler, showEnableToggle: true),
				YCrusher = new FloatCrusher(BitPresets.Bits12, -180f, 180f, Axis.Y, TRSType.Euler, showEnableToggle: true),
				ZCrusher = new FloatCrusher(BitPresets.Disabled, -180f, 180f, Axis.Z, TRSType.Euler, showEnableToggle: true)
			};
			SclCrusher = new ElementCrusher(TRSType.Scale, enableTRSTypeSelector: false)
			{
				uniformAxes = ElementCrusher.UniformAxes.XYZ,
				UCrusher = new FloatCrusher(8, 0f, 2f, Axis.Uniform, TRSType.Scale, showEnableToggle: true)
			};
		}
	}
